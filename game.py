...
class Game:
  ...
  def run( self,game_time=90 ):
    ...
    while not self.gameOver:
      ...
      # Change the display
      timePassed = time.time() - game_start
      self.display.update( self.state.data,game_time-int(timePassed))
      ...
      # self.display.updateTime(180 - int(timePassed))
